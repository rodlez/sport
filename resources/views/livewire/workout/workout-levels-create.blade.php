<div class="max-w-7xl mx-auto sm:pb-8 sm:px-6 lg:px-8">
    ...
    <div class="flex flex-row justify-start items-start gap-1 text-sm py-3 px-4 text-slate-500">
        ...
        <a href="/wk_levels/create" class="font-bold text-black border-b-2 border-b-violet-600">New</a>
    </div>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        ...
        <div>
            ...
            <div class="flex flex-row justify-between items-center py-4 bg-violet-400">
                <div>
                    <span class="text-lg text-white px-4">New Level </span>
                </div>
                <div class="px-4">
            ...
            @if ($show % 2 != 0)
                <div class="flex flex-row justify-start w-fit pt-4 px-4 sm:px-12">
                    <div class="bg-black text-sm text-white p-2 mx-2 rounded-lg relative">
                        <span class="text-violet-400 font-bold">HELP - </span> Add multiple levels using the Add button.
            ...
            <div class="mx-auto w-11/12 py-4 px-2">
                ...
                @foreach ($inputs as $key => $value)
                    <div class="flex flex-row justify-start items-center gap-2 py-2">
                        ...
                        <input wire:model="inputs.{{ $key }}.name" type="text" id="inputs.{{ $key }}.name" class="w-full sm:w-1/2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-violet-500 focus:border-violet-500 placeholder:text-zinc-400 px-2" placeholder="Enter a name">
                        @if ($count > 0)
