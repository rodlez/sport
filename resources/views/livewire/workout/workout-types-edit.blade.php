<div class="max-w-7xl mx-auto sm:pb-8 sm:px-6 lg:px-8">
    ...
    <div class="flex flex-row justify-start items-start gap-1 text-sm py-3 px-4 text-slate-500">
        <a href="/wk_types" class="hover:text-yellow-600">WK Types</a> /
        <a href="/wk_types/{{$type->id}}" class="hover:text-yellow-600">Info</a> /
        <a href="/wk_types/edit/{{ $type->id }}" class="font-bold text-black border-b-2 border-b-yellow-600">Edit</a>
    </div>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        ...
        <div class="mx-auto w-11/12 py-4 px-2">
            <form action="{{ route('wk_types.update', $type) }}" method="POST">
    ...
    <div class="flex flex-row justify-end items-center py-4 px-4 bg-yellow-400 sm:rounded-b-lg">
        <a href="{{ route('wk_types.show', $type) }}">
